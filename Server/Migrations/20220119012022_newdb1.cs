    ...
    public partial class newdb1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 88288675, "Black", "Yu Xuan" },
                    { 2, 92277216, "White", "Amir" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 88288674, "Lee", "Jian Hong" },
                    { 2, 92277213, "Goh", "Yu sheng" }
                });

            migrationBuilder.InsertData(
                table: "Events",
                columns: new[] { "Id", "CategoryId", "CreatedTime", "EndingTime", "EventName", "Participants", "StartingTime", "Venue" },
                values: new object[] { 1, 1, new DateTime(2022, 1, 19, 9, 20, 21, 52, DateTimeKind.Local).AddTicks(2071), new DateTime(2022, 1, 19, 11, 20, 21, 52, DateTimeKind.Local).AddTicks(451), "Student Help Program", 10, new DateTime(2022, 1, 19, 10, 20, 21, 48, DateTimeKind.Local).AddTicks(6320), "Classroom" });

            migrationBuilder.InsertData(
                table: "Events",
                columns: new[] { "Id", "CategoryId", "CreatedTime", "EndingTime", "EventName", "Participants", "StartingTime", "Venue" },
                values: new object[] { 2, 2, new DateTime(2022, 1, 19, 9, 20, 21, 52, DateTimeKind.Local).AddTicks(5311), new DateTime(2022, 1, 19, 11, 20, 21, 52, DateTimeKind.Local).AddTicks(5304), "Gaming Competition", 5, new DateTime(2022, 1, 19, 10, 20, 21, 52, DateTimeKind.Local).AddTicks(5274), "Lab" });
